...
@section('title', 'Edit Data Diskon | ' . config('app.name', 'E-Billing'))
...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header text-white" style="background-color: #28A745;">
            <h5 class="mb-0 text-white"><i class="bx bx-edit me-2"></i>Edit Data Diskon</h5>
        </div>
        <div class="card-body">
            <form method="post" action="{{ route('data-diskon.update', $diskon->id_diskon) }}">
                @csrf
                @method('put')
